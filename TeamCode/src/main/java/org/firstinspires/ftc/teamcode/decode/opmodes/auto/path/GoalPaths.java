...
public class GoalPaths {
    ...
    public static Pose
            ...
            gateCycleControl21 = new Pose(20.9, 59.50),
            intakeGateCycle21 = new Pose(13.5, 61),
            intakeGateCycleRed21 = new Pose(13.5, 61),
            intakeGateCycleBlue21 = new Pose(13.5, 61),
    ...
    public static double
            ...
            gateCycleIntakeAngleRed = Math.toRadians(160.5),
            gateCycleIntakeAngleBlue = Math.toRadians(160.5),
            gateCycleIntakeAngle = Math.toRadians(160.5),
            ...
            preloadShoot21Angle = Math.toRadians(260);
    ...
    public void mirrorAll() {
        ...
        preloadShoot21 = preloadShoot21.mirror();
        ...
        preloadShoot21Angle = mirrorAngleRad(preloadShoot21Angle);
    ...
    public void goal21Build(){
        shootPreload21 = f.pathBuilder()
                ...
                .setLinearHeadingInterpolation(start.getHeading(), preloadShoot21Angle)
                .addPath(
                        new BezierLine(preload21, preloadShoot21)
                )
                .setConstantHeadingInterpolation(preloadShoot21Angle)
                .build();

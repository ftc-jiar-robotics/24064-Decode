...
@Autonomous
public class ConfigureLaserRangefinder_Intake extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        LaserRangefinder leftLRF = new LaserRangefinder(hardwareMap.get(RevColorSensorV3.class, "intakeSensorFront"));
        LaserRangefinder rightLRF = new LaserRangefinder(hardwareMap.get(RevColorSensorV3.class, "intakeSensorBack"));

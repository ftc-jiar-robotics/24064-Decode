 ...
 */
public class SolversPIDF extends Controller {
     ...
     */
    public SolversPIDF(double kp, double ki, double kd, double kf) {
     ...
     */
    public SolversPIDF(PIDFCoefficients coefficients) {
     ...
     */
    public SolversPIDF(double kp, double ki, double kd, double kf, double sp, double pv) {
        kP = kp;
        kI = ki;
        kD = kd;
        kF = kf;
     ...
     */
    public SolversPIDF setIntegrationControl(IntegrationControl integrationControl) {

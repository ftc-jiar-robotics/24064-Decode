    ...
    private void shootHP() {
        ...
        robot.actionScheduler.addAction(
                new SequentialAction(
                        ...
                        PathBuilder.buildPath(path.humanPlayerIntake0, f, false, AudiencePaths.MAX_HP_TIME_MS,
                        ...
                        new SleepAction(0.1),
                        PathBuilder.buildPath(path.humanPlayerShoot1, f, true,
                                new PathBuilder.PathBuilderCallback(new InstantAction(() -> f.setMaxPower(1)), path.humanPlayerShoot1, .01, 0, f, "speed_up_hp_post_intake"), // speed up to dash back to close triangle and start shooting procedure
                                new PathBuilder.PathBuilderCallback(
                                        new ParallelAction(
                                                new InstantAction(() -> f.setMaxPower(1)),
    ...
    private void shootFirst() {
        ...
        robot.actionScheduler.addAction(
                new SequentialAction(
                        ...
                        PathBuilder.buildPath(path.firstShoot, f, false,
                                new PathBuilder.PathBuilderCallback(
                                        new ParallelAction(
                                                new InstantAction(() -> f.setMaxPower(1)),
                                                RobotActions.setIntake(1, 0)
                                ...
                                new PathBuilder.PathBuilderCallback(new InstantAction(() -> f.setMaxPower(1)), path.firstShoot, 0.01, 2, f, "speed_up_1_post_intake"), // speed up after intake
                                new PathBuilder.PathBuilderCallback(
                                        new ParallelAction(
                                                new InstantAction(() -> f.setMaxPower(1)),
                                                RobotActions.armTurret(),

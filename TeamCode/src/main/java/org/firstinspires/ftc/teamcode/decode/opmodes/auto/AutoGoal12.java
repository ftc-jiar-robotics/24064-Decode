...
public class AutoGoal12 extends AbstractAuto{
        ...
        robot.actionScheduler.addAction(
                new SequentialAction(
                        ...
                        new ParallelAction(
                                ...
                                path.thirdShoot, 0.9, 0, f, "slow_down_3"), // slow down to intake balls
    ...
    private void shootSecond() {
        ...
        robot.actionScheduler.addAction(RobotActions.shootArtifacts(3, 3));
             ...
             new SequentialAction(
                     ...
                     new ParallelAction(
                             new Actions.CallbackAction(
                                     ...
                                     path.firstIntake, 0.8, 0, f, "slow_down_1"), // slow down to intake balls
